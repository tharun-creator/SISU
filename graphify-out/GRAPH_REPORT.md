...
4. `User` - 87 edges
5. `Meeting` - 85 edges
6. `DateAvailabilitySignal` - 72 edges
7. `Communities (141 total, 52 thin omitted)` - 71 edges
8. `Notification` - 70 edges
9. `User` - 69 edges
...
Cohesion: 0.18
Nodes (18): ActionItemToggleRequest, int, Session, SessionLogCreate, User, bool, int, Session (+10 more)

### Community 3 - "Community 3"
Cohesion: 0.13
Nodes (14): Common Issues, Google Cloud Console API Setup Guide, Prerequisites, Production Deployment, Security Notes, Step 1: Create a Google Cloud Project, Step 2: Enable Required APIs, Step 3: Create OAuth 2.0 Credentials (+6 more)
...
Cohesion: 0.06
Nodes (34): 1. Project Overview & Structure, 2.1 — `backend/token.json`, 2.2 — `client_secret_717457595909-v49c5kd8lv866f0l1nig011usu91s559.apps.googleusercontent.com.json`, 2.3 — Exposed OAuth Client IDs, 2. Severity 1 — Secrets & Credentials Leaked, 3.1 Authentication, 3.2 Authorization, 3.3 Data Protection (+26 more)

### Community 18 - "Community 18"
Cohesion: 0.27
Nodes (31): DateSignalRequest, MeetingStatusUpdate, UserCreateRequest, UserDemoteRequest, UserPromoteRequest, UserStatusUpdateRequest, BackgroundTasks, DateSignalRequest (+23 more)
...
Cohesion: 0.18
Nodes (10): BookingForm(), COMM_METHODS, DURATIONS, generateTimeOptions(), MEETING_TYPES, MENTORS, PRIORITIES, Slot (+2 more)
...
Cohesion: 0.40
Nodes (4): str, JSONFormatter, setup_logging(), LogRecord
...
Cohesion: 0.05
Nodes (39): dependencies, autoprefixer, axios, date-fns, framer-motion, lucide-react, postcss, react (+31 more)

### Community 50 - "Community 50"
Cohesion: 0.40
Nodes (4): CaptchaChallenge, EmailVerificationToken, PasswordResetToken, SecurityLog

### Community 51 - "Community 51"
Cohesion: 0.47
Nodes (5): Config, UserBase, UserCreate, UserOut, UserUpdate
...
Cohesion: 0.36
Nodes (9): log_booking_action(), log_booking_action(), trigger_zapier_cancellation(), int, Session, str, Notify Zapier that a meeting has been cancelled. RETIRED: No-op., Notify Zapier that a meeting has been cancelled. RETIRED: No-op. (+1 more)
...
Cohesion: 0.09
Nodes (48): check_conflicts(), create_event(), create_event_direct(), delete_event(), _format_datetime(), get_free_slots(), _get_service(), check_conflicts() (+40 more)
...
Cohesion: 0.08
Nodes (20): AdminCalendarSlotsPage, AdminDashboard, AdminDecisionFeed, AdminReschedulePage, AdminSlotsBookedPage, AdminUsersPage, BookingPage, ClientDashboard (+12 more)
...
Cohesion: 0.18
Nodes (43): _base_template(), _booking_received_html(), _cancellation_html(), _cta_button(), _html_to_text(), _meeting_approved_html(), _meeting_card(), _meeting_rejected_html() (+35 more)
...
Cohesion: 0.10
Nodes (19): MeetingPriority, MeetingStatus, AdminEmail, AvailabilitySlot, Booking, CaptchaChallenge, DateAvailabilitySignal, Meeting (+11 more)
...
- **Are the 13 inferred relationships involving `Session` (e.g. with `LoginRequest` and `RegisterRequest`) actually correct?**
